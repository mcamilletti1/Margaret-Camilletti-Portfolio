...
<strong>Libraries and Frameworks |</strong> React, Node.js, Express.js, Django, Flask<br></br>
<strong>Database |</strong> PostgreSQL, Sequelize, ORM, MongoDB, Mongoose, ODM, ElephantSQL, MongoDBAtlas<br></br>
<strong>Other |</strong> RESTful Routing JSON, MERN stack, ChatGPT, Canva, Figma, Wix, Squarespace, MailChimp<br></br><br></br>

<strong>TECHNICAL PROJECTS<br></br><br></br>
WalkSafeNYC |</strong> Full-Stack React Application<br></br>
...
<strong>Social Media/Digital Content Intern | Fusion Theatre Company | New York, NY	9/2020-08/2021</strong>
<ul><li>Posted and ran livestreams on social media accounts, made updates and changes to Wix website, designed and created posters and promotional content using Canva for upcoming shows and fundraisers</li>
<li>Designed and sent promotional emails to clients and sponsors using MailChimp</li></ul><br></br><br></br>

<strong>Ticket Agent | TodayTix | New York, NY</strong><br></br>
<ul><li>Purchased tickets, entered data, and organized ticket inventory for TodayTix, a Broadway ticket company</li>
<li>Provided excellent customer service for customers, including accommodating for customers’ specific accessibility needs</li>
<li>Stayed up-to-date on constantly-changing news, rules, and guidelines related to the Broadway community and Broadway ticket sales to better assist customers</li>
<li>Maintained consistent work ethic in fast-paced and demanding work environment</li></ul><br></br><br></br>
...
<strong>Marymount Manhattan College |</strong> Bachelor’s of Fine Arts | New York, NY				5/2022
